...
import { Line, LineChart, CartesianGrid, XAxis, YAxis, Tooltip, ResponsiveContainer, Legend, Label } from 'recharts';
        ...
        <FlexBetween m="1rem 2.5rem" gap="1rem">
            <Box>
                ...
                <Typography variant="h6">
                    charted revenue and predicted revenue based on regression model
                </Typography>
            </Box>
